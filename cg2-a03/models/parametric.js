 ...
 *
 * Defines constructor functions Torus(), Sphere(), and ParametricSurface().
 * Sphere() and Torus() simply define the required functions
 * and delegate object creation to ParametricSurface().
 *
 */
...
/*
   ...
   */ 
    ...
    var ParametricSurface = function(gl, definition, config) {
        ...
        // dummy/test object defines an X-Y-plane through Z=0
        ...
        // wireframe is a public attribute
        ...
        window.console.log("creating a " + (this.wireframe? "wireframe " : "") + 
                            "parametric surface with " + (uSegments+1) + "*" + (vSegments+1) + 
    ...
    /*
       ...
       Uses GenerateParametricSurface to create the respective 
       vertex attributes. 
